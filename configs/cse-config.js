...
window.StudiengangConfig = {
  ...
  defaultColorMode: "pruefungsblock",
  ...
  kategorien: [
    ...
    },
    {
      ...
      klasse: "vertiefung",
      info: "2 Module auswählen (Robotik)",
      hasTooltip: true,
    },
  ],
  ...
  daten: [
    ...
    {
      jahr: 2,
      name: "Molekulare Quantenmechanik",
      kp: 4,
      pruefungsblock: "Prüfungsblock G4",
      ng: 1,
    },
  ...
  modulDetails: {
    ...
    "Statistische Physik und Computer Simulation": {
      kurzbeschreibung:
        "Der Kurs vermittelt zentrale Prinzipien und Anwendungen der statistischen Mechanik, einschließlich Gleichgewichts-Molekulardynamik, Monte-Carlo-Verfahren, stochastischer Dynamik und Methoden zur Berechnung freier Energien. In den begleitenden Übungen werden Computersimulationsprogramme eingesetzt, um Ensembles zu erzeugen und statistische Mittelwerte zu bestimmen.",
      inhalt:
    ...
    "Physikalische Chemie III": {
      kurzbeschreibung:
        "Vertiefung in die physikalische Chemie mit Fokus auf molekulare Quantenmechanik",
      inhalt:
