...
window.StudiengangModuleDetails = {
    ...
    "Image Analysis and Computer Vision": {
        kurzbeschreibung: "Comprehensive introduction to computer vision and image analysis techniques",
        inhalt:
    ...
    "Information Systems for Engineers": {
        kurzbeschreibung: "Introduction to information systems design and management for engineering applications",
        inhalt:
    ...
    "Communication Networks": {
        kurzbeschreibung: "Fundamentals of computer networks and communication protocols",
        inhalt:
