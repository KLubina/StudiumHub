(function (root, factory) {
    if (typeof module === 'object' && module.exports) {
        ...
        root.itetExtensionsData = factory();
    }
    ...
    return {
        kernfaecherSchwerpunkte: {
            "Biomedizinische Technik": [
                ...
                { name: "Neural Systems", kp: 6, kategorie: "Kernfächer nach Schwerpunkt" }
            ],
            "Computer und Netzwerke": [
                { name: "Discrete Event Systems", kp: 6, kategorie: "Kernfächer nach Schwerpunkt" },
            ...
            "Elektrische Energietechnik": [
                ...
                { name: "Power Semiconductors", kp: 6, kategorie: "Kernfächer nach Schwerpunkt" },
            ...
            "Elektronik und Photonik": [
                ...
                { name: "Radio-Frequency Electronics I", kp: 6, kategorie: "Kernfächer nach Schwerpunkt" },
                { name: "High-Speed Signal Propagation", kp: 6, kategorie: "Kernfächer nach Schwerpunkt" },
                { name: "Optics and Photonics", kp: 6, kategorie: "Kernfächer nach Schwerpunkt" },
                { name: "Mess- und Versuchstechnik", kp: 6, kategorie: "Kernfächer nach Schwerpunkt" }
            ],
            "Kommunikation, Regelung und Signalverarbeitung": [
                ...
                { name: "Communication and Detection Theory", kp: 6, kategorie: "Kernfächer nach Schwerpunkt" },
                { name: "Fundamentals of Physical Modeling and Simulations", kp: 6, kategorie: "Kernfächer nach Schwerpunkt" },
        ...
        weitereWahlGrundlagen: [
            { name: "Computational Thinking", kp: 4, kategorie: "Weitere Wahl-Grundlagenfächer" },
            { name: "High-Frequency Design Techniques", kp: 4, kategorie: "Weitere Wahl-Grundlagenfächer" },
            { name: "Introduction to Electric Power Transmission: System & Technology", kp: 4, kategorie: "Weitere Wahl-Grundlagenfächer" }
        ],
