...
const EventHandlers = {
  setupEventListeners() {
    ...
    const viewAllVisualizations = document.getElementById(
      "viewAllVisualizations",
    );
    ...
    viewByInstitution.addEventListener("click", function () {
      ...
      document.getElementById("studyProgramsContainer").style.display = "block";
    ...
    viewAllVisualizations.addEventListener("click", function () {
      ...
      viewByInstitution.classList.remove("active");
      viewByCategory.classList.remove("active");
      document.getElementById("studyProgramsContainer").style.display = "none";
