...
function getVertiefungsgebieteByKategorie(kategorie) {
  return window.CSE_VertiefungsgebieteModules.filter(
...
function generateVertiefungsgebieteHTML() {
  let html =
    '<div class="vertiefungsgebiete-liste"><h3>Vertiefungsgebiete</h3>';
...
if (typeof window !== "undefined") {
  ...
  window.getVertiefungsgebieteByThemenbereich =
