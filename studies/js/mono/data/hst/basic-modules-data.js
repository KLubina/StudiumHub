...
window.StudiengangModules = [
    ...
    { jahr: 2, semester: 1, name: "Laboratory Course in Medical Technology", kp: 2, kategorie: "Kernfach" },
    { jahr: 2, semester: 1, name: "Produktentwicklung in der Medizintechnik", kp: 4, kategorie: "Kernfach" },

    // ========== SEMESTER 4 - Kernfächer Block C ==========
    { jahr: 2, semester: 2, name: "Humanphysiologie II", kp: 5, kategorie: "Kernfach" },
    { jahr: 2, semester: 2, name: "Biomechanik II", kp: 4, kategorie: "Kernfach" },
    { jahr: 2, semester: 2, name: "Biomedizinische Grenzflächen", kp: 4, kategorie: "Kernfach" },
    { jahr: 2, semester: 2, name: "Praktikum Physiologie (HST)", kp: 3, kategorie: "Kernfach" },
