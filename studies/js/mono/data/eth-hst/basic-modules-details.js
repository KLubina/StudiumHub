window.StudiengangModuleDetails = {
  ...
  "Molekulare Genetik und Zellbiologie": {
    ...
    inhalt:
      ...
      "• Evolution von Krankheiten\n\n" +
      "► Zellbiologie\n" +
      "• Die Zelle als kleinste Einheit des Körpers\n" +
      "• Störungen der Zellfunktionen in Krankheiten\n" +
      "• Therapieansätze\n" +
      "• Zellvervielfältigung im Körper\n" +
      "• Fehler bei der Zellvervielfältigung und resultierende Krankheiten\n\n" +
      "► DNA und Molekularbiologie\n" +
      "• DNA als Grundlage des Lebens\n" +
      "• Informationsspeicherung in der DNA\n" +
      "• DNA-Vervielfältigung und Schutz vor Schäden\n" +
      "• Informationsablesung und Proteinübersetzung\n" +
      "• Krankheitsmechanismen auf DNA-, RNA- und Proteinebene\n\n" +
      "► Diagnostik und Therapie\n" +
      "• Technologien zur Diagnostik von Krankheiten\n" +
      "• Therapiemöglichkeiten\n\n" +
      "► Genetik\n" +
      "• Genetische Unterschiede zwischen Menschen\n" +
      "• Molekulare Grundlagen genetischer Unterschiede\n" +
      "• Genetische Unterschiede und Krankheiten\n" +
      "• Nicht-krankheitsrelevante genetische Variationen\n\n" +
      "► Erbkrankheiten\n" +
      "• Molekulare Ursachen häufiger Erbkrankheiten\n" +
      "• Wahrscheinlichkeitsbestimmung des Auftretens\n" +
      "• Weitergabe an Nachkommen\n\n" +
      "► Entwicklungsbiologie\n" +
      "• Biochemische und molekulare Grundlagen der menschlichen Fortpflanzung\n" +
      "• Grundprinzipien der Embryonalentwicklung\n" +
      "• Störungen bei fehlerhafter Entwicklung",
  ...
  "Grundlagen der Informatik": {
    ...
    inhalt:
      ...
      "• Matrizenrechnen\n" +
      "• Zufallsexperimente\n" +
      "• Daten verwalten mit relationalen Datenbanken",
  ...
  "Einführung Gesundheitswissenschaften und Technologie I": {
    ...
    link: "https://www.vvz.ethz.ch/Vorlesungsverzeichnis/lerneinheit.view?lerneinheitId=193757&semkez=2025W&ansicht=LEHRVERANSTALTUNGEN&lang=de",
  },
  // #endregion
  ...
  "Mathematik I": {
    ...
    inhalt:
      ...
      "• Grundlagen und zentrale Beispiele: Exponentiell, Beschränkt, Logistisch, Gompertz\n" +
      "• Qualitative Beschreibung: Stationäre Lösungen, Monotonie, Konvergenz\n" +
      "• Lineare DGL 1. Ordnung\n" +
      "• Trennung der Variablen\n" +
      "• Richtungsfeld und Euler-Verfahren\n\n" +
  ...
  "Organische Chemie I": {
    ...
    inhalt:
      ...
      "• Konstitution, kovalente Bindungen\n" +
      "• Molekülgeometrie\n" +
      ...
      "• Resonanztheorie und Grenzstrukturen\n" +
      "• Aromatizität\n\n" +
      "► Stereochemie\n" +
      "• Chiralität\n" +
      "• Konfiguration\n" +
      ...
      "• Moleküldynamik und Konformationsanalyse\n\n" +
      ...
      "• Reaktive Zwischenstufen: Radikale, Carbeniumionen, Carbanionen",
    link: "https://www.vvz.ethz.ch/Vorlesungsverzeichnis/lerneinheit.view?lerneinheitId=193393&semkez=2025W&ansicht=LEHRVERANSTALTUNGEN&lang=de",
  },
  // #endregion
  ...
  "Organische Chemie II": {
    ...
    inhalt:
      ...
      "• Mittlere Bindungsenthalpien, Spannung\n" +
      "• Einstufige Reaktionen (Synchron-Reaktionen)\n" +
      "• Mehrstufige Reaktionen\n" +
      "• Reaktive Zwischenstufen\n" +
      "• Lösungsmittel, Solvatation, H-Brücken\n" +
      "• Elemente der Konformationsanalyse\n\n" +
      "► Alkane und Cycloalkane\n" +
      "• Definitionen und physikalische Daten\n" +
      "• van-der-Waals-Kräfte, Polarisierbarkeit, Ringspannung\n" +
      "• Gewinnung und Verwendung von Alkanen\n" +
      "• Radikalische Halogenierung von Alkanen\n" +
      "• Verbrennung\n\n" +
      "► Halogenalkane\n" +
      "• Physikalische Eigenschaften, Herstellungsmethoden\n" +
      "• Nukleophile Substitution\n" +
      "• Halogenhaltige Naturstoffe\n\n" +
      "► Alkene\n" +
      "• Herstellung von Alkenen, Eliminierungsreaktionen\n" +
      "• Elektrophile Addition an Alkene\n" +
      "• Diels-Alder-Reaktion\n" +
      "• 1,3-Dipolare Cycloadditionen\n" +
      "• Alkene als Naturstoffe\n\n" +
      "► Alkine, Cycloalkine\n" +
      "• Struktur und physikalische Eigenschaften\n" +
      "• Herstellungsmethoden für Alkine\n" +
      "• Reaktionen von Alkinen\n" +
      "• Naturstoffe und Wirkstoffe mit Acetylen-Einheiten\n\n" +
      "► Aromatische Verbindungen\n" +
      "• Benzol und die Hückel-Regel\n" +
      "• Weitere Aspekte der Aromatizität\n" +
      "• Wichtige aromatische Carbo- und Heterocyclen\n" +
      "• Elektrophile Substitution am Aromaten (SEAr)\n" +
      "• Zweitsubstitution am Aromaten\n" +
      "• Nitroverbindungen als Synthesezwischenprodukte\n\n" +
      "► Die Carbonylgruppe I\n" +
      "• Aldehyde und Ketone\n" +
      "• Nukleophile Addition von Grignard-Verbindungen\n" +
      "• Oxidationen und Reduktionen\n" +
      "• Umsetzung mit Wasser, Alkoholen, Stickstoffverbindungen\n\n" +
      "► Die Carbonylgruppe II\n" +
      "• Carbonsäuren und ihre Derivate\n" +
      "• Veresterung und Verseifung\n" +
      "• Carbonsäureanhydride und -chloride\n" +
      "• Carbonsäureamide\n" +
      "• Derivate der Kohlensäure\n\n" +
      "► Die Carbonylgruppe III\n" +
      "• Enolate von Carbonylverbindungen\n" +
  ...
  "Mathematik II": {
    ...
    inhalt:
      ...
      "• Potentialtheorie\n" +
      "• Formel von Green\n" +
      "• Divergenz und Ebener (und Räumlicher) Satz von Gauss",
  ...
  "Statistik I": {
    ...
    inhalt:
      ...
      "• Binomial-Verteilung\n" +
      "• Tests und Vertrauensintervalle für eine Wahrscheinlichkeit\n" +
      "• Poisson-Verteilung und deren Statistik\n" +
  ...
  "Praktikum Chemie": {
    ...
    inhalt:
      ...
      "► Chemische Synthesen\n" +
      "• Ausgewählte Synthesen (z.B. Aspirin)\n\n" +
      "► Komplexchemie\n" +
      "• Löslichkeit\n\n" +
      "► Säure-Base-Chemie\n" +
  ...
  "Humanphysiologie I": {
    ...
    inhalt:
      ...
      "• Prinzipien für das Verständnis aller physiologischen Prozesse\n\n" +
      "► Allgemeine Endokrinologie und endokrines System\n" +
      "• Hormonelle Kontrolle der Organfunktionen\n\n" +
      "► Allgemeine Neurophysiologie und Neuroanatomie\n" +
      "• Nervale Kontrolle der Organfunktionen\n\n" +
      ...
      "► Flüssigkeitshomöostase und Niere\n" +
      "• Regulation des Flüssigkeitshaushalts\n" +
      "• Nierenfunktion\n\n" +
      "► Reproduktion, Entwicklung und Altern\n" +
      "• Fortpflanzung\n" +
  ...
  "Mathematik III": {
    ...
    inhalt:
      ...
      "• Pocken-Modell: Effekt von Impfungen\n\n" +
      "► Lineare Modelle\n" +
      "• Vektorräume\n" +
  ...
  "Statistik II": {
    ...
    inhalt:
      ...
      "• Kritische Analyse bestehender Studien",
  ...
  "Physik I": {
    ...
    link: "https://www.vvz.ethz.ch/Vorlesungsverzeichnis/lerneinheit.view?lerneinheitId=194153&semkez=2025W&ansicht=LEHRVERANSTALTUNGEN&lang=de",
  },
  // #endregion
  ...
  "Laboratory Course in Medical Technology": {
    ...
    inhalt:
      ...
      "• 3D-gedruckte Prototypen testen\n\n" +
      "► Knochenplatten-Projekt\n" +
      "• Vorfall simulieren\n" +
      "• Knochenplatte entwerfen\n" +
      "• FEM-Analyse der Knochenplatte\n" +
      "• Optimierung basierend auf FEM-Auswertung\n\n" +
      "► Robotik\n" +
      "• Softwareentwicklung\n" +
      "• Roboterarm programmieren\n" +
      "• Hardware für Roboterarm (Kraftsensor, EMG)",
  ...
  "Produktentwicklung in der Medizintechnik": {
    ...
    inhalt:
      ...
      "• Mechanik\n" +
      "• Festigkeitslehre\n\n" +
      "► Biomechanik und Materialien\n" +
      "• Gewebebiomechanik\n" +
      "• Biomaterialien, Oberflächen und Abrieb\n\n" +
      "► Prothesen\n" +
      "• Prothesen: Biomechanik und Konstruktion\n" +
      "• Allograft: Herzklappen\n\n" +
      "► Evaluation und Zulassung\n" +
      "• Präklinische Bewertung\n" +
      "• Validierung\n" +
      "• Zulassung (MepV, FDA, CE)\n" +
      "• Klinische Evaluation\n\n" +
      "► Geistiges Eigentum\n" +
      "• Patente und Schutzrechte",
    link: "https://www.vvz.ethz.ch/Vorlesungsverzeichnis/lerneinheit.view?lerneinheitId=194204&semkez=2025W&ansicht=LEHRVERANSTALTUNGEN&lang=de",
  },
  // #endregion
  ...
  "Molekular- und Zellbiologie in Gesundheit und Krankheit": {
    ...
    inhalt:
      ...
      "• Kollagen und dessen pathologische Prozesse\n\n" +
      "► Protein Krankheiten\n" +
      "• Mutationen\n" +
      "• Aggregate\n\n" +
      "► Enzyme in der Pathologie\n" +
      "• Enzymmangel\n" +
      "• Drug Targets\n" +
      "• Arzneimittelinteraktionen\n" +
      "• Biomarker\n\n" +
      "► Diagnostische Methoden\n" +
      "• Biochemische Methoden in der Diagnostik\n\n" +
      "► Membran- und Lipiderkrankungen\n" +
      "• Lipidabhängige Erkrankungen\n" +
      "• Fettstoffwechsel\n" +
      "• Cholesterinstoffwechsel\n" +
      "• Cholesterin im Nervensystem\n" +
      "• Membranerkrankungen im Nervensystem\n\n" +
      "► Proteinvermittelte Bewegung\n" +
      "• Proteine als Motorfunktion\n" +
      "• Muskelerkrankungen\n" +
      "• Myotonien\n" +
      "• Kardiomyophathien\n\n" +
      "► Zelluläre Kommunikation\n" +
      "• Prinzip der hormonellen Wirkungen\n" +
      "• Schilddrüse\n" +
      "• Betazelle\n" +
      "• Insulin\n" +
      "• Diabetes\n" +
      ...
      "► Metabolismus\n" +
      "• Kohlenhydratstoffwechsel und Erkrankungen\n" +
  ...
  "Physik II": {
    ...
    link: "https://www.vvz.ethz.ch/Vorlesungsverzeichnis/lerneinheit.view?lerneinheitId=188034&semkez=2025S&ansicht=LEHRVERANSTALTUNGEN&lang=de",
  },
  // #endregion
  ...
  "Humanphysiologie II": {
    ...
    inhalt:
      ...
      "► Höhere zentralnervöse Hirnfunktionen\n" +
  ...
  "Biomechanik II": {
    ...
    inhalt:
      ...
      "► Inverse Dynamik\n" +
      "• Rückrechnung von Kräften aus Bewegungsdaten\n\n" +
      "► Muskelmechanik\n" +
      "• Muskelmodelle\n" +
      "• Muskeloptimierung",
  ...
  "Biomedizinische Grenzflächen": {
    ...
    inhalt:
      ...
      "• Beschichtungen zur Verhinderung unerwünschter Adhäsion\n\n" +
      "► Biosensoren\n" +
      "• Sensordesign für biomedizinische Anwendungen\n\n" +
      "► Bakterien-Oberflächen Wechselwirkungen\n" +
      "• Bakterielle Adhäsion und Biofilme\n\n" +
      "► Zell-Nanopartikel Wechselwirkungen\n" +
      "• Wechselwirkungen auf Nanoskala\n\n" +
      "► Drug Delivery Systeme\n" +
      "• Medikamentenabgabesysteme\n\n" +
      "► Zell-Substrat Wechselwirkungen\n" +
      "• Zelladhäsion und Zellverhalten auf Materialien\n\n" +
      "► Tissue Engineering\n" +
      "• Gewebezüchtung auf Biomaterialien",
    link: "https://www.vvz.ethz.ch/Vorlesungsverzeichnis/lerneinheit.view?lerneinheitId=188502&semkez=2025S&ansicht=LEHRVERANSTALTUNGEN&lang=de",
  },
  // #endregion
  ...
  "Praktikum Physiologie": {
    ...
    inhalt:
      ...
      "► Muskelfunktion\n" +
      "• Aufzeichnung von Elektromyogramm (EMG)\n" +
      "• Einzelstimulation und Summation\n" +
      "• Mechanogramm\n\n" +
      "► Lungenfunktion\n" +
      ...
      "• Orthostatische Veränderung\n" +
      "• Körperliche Aktivität\n" +
      "• Computersimulation der Herz-Kreislauf-Funktion\n\n" +
      "► Sinnesorgane\n" +
      "• Bestimmung von Hörschwelle\n" +
      "• Sehschärfe\n" +
