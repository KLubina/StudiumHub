...
window.StudiengangModules = [
    ...
    { jahr: 1, semester: 2, name: "Mathematische Methoden (ehem. Komplexe Analysis)", kp: 4, ng: 1 },
    { jahr: 1, semester: 2, name: "Chemie", kp: 4, ng: 1 },
    { jahr: 1, semester: 2, name: "Analysis II", kp: 8, ng: 3 },
    { jahr: 1, semester: 2, name: "Datenstrukturen und Algorithmen", kp: 8, ng: 2 },
    ...
    { jahr: 2, name: "Wahrscheinlichkeitstheorie und Statistik (ehem. Stochastik)", kp: 4, ng: 1 },
    { jahr: 2, name: "Numerical Methods for Partial Differential Equations", kp: 10, ng: 2 },
    { jahr: 2, name: "Programmiertechniken für physikalische Simulationen", kp: 5, ng: 1 },
    { jahr: 2, name: "Systems Programming and Computer Architecture", kp: 7, ng: 1 },
    { jahr: 2, name: "Wissenschaft im Kontext", kp: 6, kategorie: "wissenschaftliche-arbeit" },
    { jahr: 2, name: "Fluid Dynamics I", kp: 8, ng: 1 },
    { jahr: 2, name: "Statistische Physik und Computer Simulation", kp: 5, ng: 1 },
