...
function getVertiefungsgebieteByKategorie(kategorie) {
    return window.MASCH_VertiefungsgebieteModules.filter(modul => modul.kategorie_vertiefung === kategorie);
}

function getVertiefungsgebieteKategorien() {
    const kategorien = [...new Set(window.MASCH_VertiefungsgebieteModules.map(modul => modul.kategorie_vertiefung))];
    return kategorien.sort();
}

// Export für modularen Import
if (typeof window !== 'undefined') {
    window.MASCH_VertiefungsgebieteModules = window.MASCH_VertiefungsgebieteModules;
