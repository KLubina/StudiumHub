...
window.StudiengangModuleDetails = {
  ...
  "Human Resource Management: Leading Teams": {
    kurzbeschreibung:
      "Basic processes of human resource management embedded in the broader context of team leadership",
    inhalt:
  ...
  "Responsible Leadership": {
    kurzbeschreibung:
      "Different leadership styles and how power and leadership play out in social interactions with emphasis on personal development",
    inhalt:
  ...
  "Strategic Management": {
    kurzbeschreibung:
      "Key competences, frameworks and methods for designing, implementing and executing strategy",
    inhalt:
  ...
  "Corporate Sustainability": {
    kurzbeschreibung:
      "Current challenges of corporate sustainability preparing students to become champions for sustainable business practices",
    inhalt:
  ...
  "Technology and Innovation Management": {
    kurzbeschreibung:
      "Sources of innovation with focus on digital technologies, tools and techniques for routine innovation, and strategic implications of technical change",
    inhalt:
  ...
  "Introduction to Marketing": {
    kurzbeschreibung:
      "Overview of essential marketing perspectives and how marketing adds value to business with concepts, frameworks and methods for marketing decision making",
    inhalt:
  ...
  Entrepreneurship: {
    kurzbeschreibung:
      "Various elements important to start an innovative business including technology context, opportunity assessment, idea protection, market testing, team formation, and investment raising",
    inhalt:
  ...
  "Principles of Microeconomics": {
    kurzbeschreibung:
      "Basic principles, problems and approaches of microeconomics providing reflective and contextual knowledge on resource allocation",
    inhalt:
  ...
  "Sustainability Economics": {
    kurzbeschreibung:
      "Economic perspective and core tools for private and public sustainability management covering dynamic systems, trade-offs, and business/policy tools",
    inhalt:
  ...
  "Economic Growth, Cycles and Policy": {
    kurzbeschreibung:
      "Core thinking devices and foundations in macroeconomics and monetary economics for understanding growth, cycles, crises and policy conduct",
    inhalt:
  ...
  "Markets and Games": {
    kurzbeschreibung:
      "Foundations of microeconomics covering markets and game theory with theoretical tools for analyzing strategic behavior in industrial organization",
    inhalt:
      "• Normal-form games\n" +
  ...
  "Accounting for Managers": {
    kurzbeschreibung:
      "Introduction to financial and managerial accounting for students aspiring for business and management careers",
    inhalt:
  ...
  "Introduction to Finance": {
    kurzbeschreibung:
      "Fundamental financial decisions encountered by corporate managers and application of financial theory to real-world challenges",
    inhalt:
      "• Time value of money\n" +
  ...
  "Advanced Finance": {
    kurzbeschreibung:
      "Advanced financial decisions for corporate managers with sophisticated financial theory applications to practical challenges",
    inhalt:
  ...
  "Production and Operations Management": {
    kurzbeschreibung:
      "Basic theories, principles, concepts, and techniques to design, analyze, and improve organizational operational capabilities",
    inhalt:
  ...
  "Strategic Supply Chain Management": {
    kurzbeschreibung:
      "Theory and practice of supply chain management with development of supply chain strategies and networks based on competitive strategies",
    inhalt:
  ...
  "Operations Research": {
    kurzbeschreibung:
      "Introduction to operations research methods in management science and economics with practical, problem-solving perspective",
    inhalt:
  ...
  "Economic Dynamics and Complexity": {
    kurzbeschreibung:
      "Complex networks examination of systemic risk in financial markets and global supply networks through interactions among firms, institutions, and countries",
    inhalt:
  ...
  "Empirical Methods in Management": {
    kurzbeschreibung:
      "Understanding and conducting empirical research enabling evidence-based business management decision-making",
    inhalt:
  ...
  "Principles of Econometrics": {
    kurzbeschreibung:
      "Fundamentals of econometrics covering simple and multiple regression analysis with emphasis on hypothesis testing and interpretation",
    inhalt:
  ...
  "Social Data Science": {
    kurzbeschreibung:
      "Techniques to analyze human behavior and social interaction through digital traces with data retrieval, processing, and analysis",
    inhalt:
  ...
  "Risk and Insurance Economics": {
    kurzbeschreibung:
      "Individual decision-making under uncertainty covering risk attitudes, insurance demand and supply, information issues, and macroeconomic role of insurers",
    inhalt:
  ...
  "Semester Project Large": {
    kurzbeschreibung:
      "Comprehensive training in solution of complex engineering problems using advanced technical and social skills from the master's program",
    inhalt:
  ...
  "Supplementary Courses": {
    kurzbeschreibung:
      "Complementary courses from various fields to broaden knowledge base and enhance interdisciplinary understanding",
    inhalt:
  ...
  "Master's Thesis": {
    kurzbeschreibung:
      "Independent research project demonstrating mastery of knowledge and research skills in management, technology, and economics",
    inhalt:
  ...
  Internship: {
    kurzbeschreibung:
      "Practical work experience in industry, consulting, or research organizations to apply academic knowledge in real-world settings",
    inhalt:
