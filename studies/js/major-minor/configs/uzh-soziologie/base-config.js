/* ==== UZH SOZIOLOGIE BASE CONFIGURATION ==== */
/* Grundlegende Konfiguration für den Bachelor Soziologie (Major) an der UZH */

window.StudiengangBaseConfig = {
    // === 1. BASIC INFO ===
    title: "Bachelor of Arts - Soziologie (Major)",
    legendTitle: "Farben-Legende",
    creditUnit: "ECTS",
    // Optional HTML subtitle (renders clickable links when provided)
    subtitleHtml: `Herbstsemester: <a href="https://studentservices.uzh.ch/uzh/anonym/vvz/index.html?sap-language=DE&sap-ui-language=DE#/details/2025/003/CGStudyProgramDetail/50891623/50000007/Philosophische%2520Fakult%25C3%25A4t/50890575/Bachelor%2520of%2520Arts%2520(RVO19)/true/50891623/Soziologie/2025/003" target="_blank" rel="noopener">VVZ Herbst 2025</a>
        <br>
        Sommersemester: <a href="https://studentservices.uzh.ch/uzh/anonym/vvz/index.html?sap-language=DE&sap-ui-language=DE#/details/2024/004/CGStudyProgramDetail/50891623/50000007/Philosophische%2520Fakult%25C3%25A4t/50890575/Bachelor%2520of%2520Arts%2520(RVO19)/true/50891623/Soziologie/2024/004" target="_blank" rel="noopener">VVZ Sommer 2024</a>
        <br>
        Studieninfo: <a href="https://www.suz.uzh.ch/de/institut/studium/bachelor.html" target="_blank" rel="noopener">Studium Bachelor</a> | <a href="https://www.phil.uzh.ch/static/rechtssammlung/bachelor/regulaer-nachfolger/mc/MC_06B-8400-120.pdf" target="_blank" rel="noopener">Studienplan & Reglement (PDF)</a>`,
    ...
    kategorieZuKlasse: {
        "major-soziologie": "major-soziologie",
        "minor": "minor",
        "pflicht": "pflicht",
        "methoden": "methoden",
    ...
    customSizing: function (div, modul) {
        ...
        // Major-Module (Soziologie = 120 ECTS)
        if (modul.kategorie === "major-soziologie") {
            width = 250;
            height = 100;
        }
    ...
    shortenModuleName: function (name) {
        if (name.includes("Soziologie")) {
            return name.replace("Soziologie", "Soz.");
        }
