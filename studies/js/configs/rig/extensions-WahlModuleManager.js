...
window.RIGWahlmoduleManager = {
    init(studienplan) {
        ...
        // Prefer external module data (loaded via modular-config-loader) if available
        // Sources tried in order: studienplan.config.wahlmoduleBereiche, window.RIGModuleData.wahlmoduleBereiche
        this.wahlmoduleBereiche = (this.studienplan && this.studienplan.config && this.studienplan.config.wahlmoduleBereiche)
            || (window.RIGModuleData && window.RIGModuleData.wahlmoduleBereiche)
            || {};
    },
