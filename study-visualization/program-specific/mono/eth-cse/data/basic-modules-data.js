...
window.StudiengangModules = [
  ...
  { jahr: 1, semester: 1, name: "Physik I", kp: 4 },
  { jahr: 1, semester: 1, name: "Informatik", kp: 4 },
  { jahr: 1, semester: 1, name: "Lineare Algebra", kp: 5 },
  { jahr: 1, semester: 1, name: "Diskrete Mathematik", kp: 7 },
  { jahr: 1, semester: 1, name: "Analysis I", kp: 8 },

  // #endregion 1. Semester

  // #region 2. Semester
  { jahr: 1, semester: 2, name: "Physik II", kp: 4 },
  {
    jahr: 1,
    semester: 2,
  ...
  { jahr: 1, semester: 2, name: "Chemie", kp: 4 },
  { jahr: 1, semester: 2, name: "Analysis II", kp: 8 },
  {
    jahr: 1,
    semester: 2,
  ...
  { jahr: 2, name: "Analysis III", kp: 4 },
  {
    jahr: 2,
    name: "Introduction to Mathematical Optimization",
    kp: 5,
  },
  { jahr: 2, name: "Numerische Methoden für CSE", kp: 9 },
  {
    jahr: 2,
  ...
  { jahr: 2, name: "Fluid Dynamics I", kp: 8 },
  {
    jahr: 2,
